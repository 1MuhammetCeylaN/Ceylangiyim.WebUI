...
namespace Ceylangiyim.WebUI.Controllers
{
    [Authorize]
    public class MyAddressesController : Controller
    {
        ...
        public MyAddressesController(IService<AppUser> appUserService, IService<Address> addressService)
        {
            _serviceAppUser = appUserService;
        ...
        public async Task<IActionResult> Edit(string id)
        {
            ...
            if (model == null) { return NotFound("Adres Bilgisi Bulunamadı!"); }
            return View(model);
        }
